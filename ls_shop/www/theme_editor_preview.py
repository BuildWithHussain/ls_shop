...
"""Renders the live theme's home page for the theme editor's iframe."""
...
def get_context(context):
	...
	rendered = render_page_preview(HOME_TEMPLATE, TRACKING_BLANKED_BLOCKS)
	if rendered:
		context.rendered_html = rendered
		return

	# No theme active, or one that ships no home page: the pane says so rather than framing a 404.
...
<p>{escape_html(frappe._("The live theme has no home page to preview."))}</p>
</body>
</html>"""
