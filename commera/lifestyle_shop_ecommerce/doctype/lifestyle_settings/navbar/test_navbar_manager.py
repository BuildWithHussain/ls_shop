...
from commera.lifestyle_shop_ecommerce.doctype.bulk_publish_variants import bulk_publish_variants
...
from commera.search import sync
...
PUBLISH_TEST_INDEX_NAME = "test_commera_navbar_publish.db"
