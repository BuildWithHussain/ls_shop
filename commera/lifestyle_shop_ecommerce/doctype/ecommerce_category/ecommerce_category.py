...
from commera.lifestyle_shop_ecommerce.doctype.lifestyle_settings.editor_input import require_safe_url
...
class EcommerceCategory(NestedSet):
	...
	if TYPE_CHECKING:
		...
		from commera.lifestyle_shop_ecommerce.doctype.ecommerce_category_item_group.ecommerce_category_item_group import (
